...
export default function Checkout() {
  ...
  // Calculate total from actual cart data instead of store
  ...
  const handlePaymentMethodSelect = (method: 'flutterwave' | 'crypto') => {
    const proceed = (data: CheckoutForm) => {
      ...
      if (method === 'flutterwave') {
        ...
        initializeFlutterwavePayment(orderData);
      } else if (method === 'crypto') {
        setLocation('/crypto-payment', { state: { order: orderData } });
      }
    };
  ...
  const initializeFlutterwavePayment = async (orderData: any) => {
  ...
  // const processOrder = (method: 'stripe' | 'crypto', formData: CheckoutForm) => {
  //   setIsProcessingPayment(true);
